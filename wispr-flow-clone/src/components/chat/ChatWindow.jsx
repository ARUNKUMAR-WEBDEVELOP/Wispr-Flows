...
export default function ChatWindow({ messages, isTyping, liveTranscript }) {
  ...
  return (
    <div className="flex-1 overflow-y-auto px-6 py-6 space-y-4 bg-gradient-to-br from-gray-50 via-purple-50/20 to-pink-50/20 dark:from-gray-900 dark:via-purple-900/10 dark:to-pink-900/10">
      {/* Empty State */}
