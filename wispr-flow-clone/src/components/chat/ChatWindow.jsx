...
export default function ChatWindow({ messages, isTyping, liveTranscript }) {
  ...
  return (
    <div className="flex-1 min-h-0 flex flex-col bg-gradient-to-br from-gray-50 via-purple-50/20 to-pink-50/20 dark:from-gray-900 dark:via-purple-900/10 dark:to-pink-900/10">
          ...
          {messages.length === 0 && !liveTranscript && (
            <div className="flex min-h-[60vh] flex-col items-center justify-center text-center space-y-6 animate-in">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400 max-w-lg">
