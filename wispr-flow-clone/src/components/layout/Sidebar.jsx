    ...
    >
      ...
      {activeTab === "history" && (
        <div className="flex-1 overflow-y-auto space-y-2 px-4 pb-4">
          <div className="text-xs font-semibold text-purple-400 px-2 mb-3 flex items-center gap-2">
            <MessageSquare size={14} />
            Your Conversations
          </div>
          {(Array.isArray(sessions) ? sessions : []).length === 0 && (
            <div className="text-gray-500 text-sm px-2 py-8 text-center bg-gray-800/30 rounded-lg border border-dashed border-gray-700">
            ...
            <motion.div
              ...
              className={`group relative p-3.5 rounded-xl cursor-pointer transition-all duration-300 overflow-hidden ${
                activeSession === session.session_id 
                  ...
                  : "bg-gray-800/50 text-gray-300 hover:bg-gray-700/60 border border-purple-500/10 hover:border-purple-500/30"
              }`}
