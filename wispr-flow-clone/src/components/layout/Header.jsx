...
export default function Header({ authenticated, onLogin }) {
  return (
    <header className="h-16 px-6 flex items-center justify-between border-b border-purple-500/20 bg-gradient-to-r from-gray-900 via-purple-900/20 to-gray-900 backdrop-blur-xl shadow-lg">
      {/* Title */}
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-xs text-gray-500">Powered by Gemini & Deepgram</p>
        </div>
      </div>
