...
export default function VoiceAgentButton({ onResponseReceived }) {
  ...
  return (
    <>
      ...
      {showModal && (
        <div 
          className="fixed inset-0 bg-gradient-to-br from-purple-900/35 via-black/55 to-pink-900/35 backdrop-blur-xl flex items-start justify-center z-[9999] pt-8 px-4 pb-4 animate-in"
          onClick={(e) => e.target === e.currentTarget && closeModal()}
        >
          <div className="glass-panel rounded-3xl shadow-2xl w-full max-w-2xl h-auto max-h-[85dvh] flex flex-col overflow-hidden modal-enter border border-purple-500/30 animate-slide-in">
