...
export default function VoiceAgentButton({ onResponseReceived }) {
  ...
  return (
    <>
      ...
      {/* Modal - Premium Glassmorphism Design - Fixed at Top */}
      {showModal && (
        <div 
          className="fixed inset-0 bg-gradient-to-br from-purple-900/35 via-black/55 to-pink-900/35 backdrop-blur-xl z-[9999] animate-in"
          onClick={(e) => e.target === e.currentTarget && closeModal()}
        >
          <div className="fixed top-8 left-1/2 -translate-x-1/2 glass-panel rounded-3xl shadow-2xl w-[calc(100%-2rem)] max-w-2xl h-auto max-h-[85dvh] flex flex-col overflow-hidden modal-enter border border-purple-500/30 animate-slide-in">
